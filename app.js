...
var taskInput = document.querySelector(".new-task__name_input"); //Add a new task.
var addButton = document.getElementsByTagName("button")[0]; //first button
var incompleteTaskHolder = document.querySelector(".task-list_incomplete");
var completedTasksHolder = document.querySelector(".task-list_complete");
...
var createNewTaskElement = function (taskString) {
  ...
  label.className = "task-list__name task-list__name_label";
  ...
  editInput.type = "text";
  editInput.className = "task-list__name task-list__name_input";
